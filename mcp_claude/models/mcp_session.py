...
class MCPSession(models.Model):
    ...
    @api.model
    def record_heartbeat(self, session_token=None, client_name="Claude Desktop", transport="remote_https", method="tools/list", user_id=2, duration_ms=0.0):
        """
        ...
        try:
            with self.env.registry.cursor() as new_cr:
                ...
                new_cr.execute(query, (
                    session_token, user_id or 2, client_name or "Claude Desktop", transport or "remote_https",
